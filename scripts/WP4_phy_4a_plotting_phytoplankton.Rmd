...
phy_sp <- phy_sp %>%
  select(aphiaidaccepted, scientificnameaccepted, datecollected, datasetID, datasetid, mrgid, eventid, month, year, season, xUTM, yUTM, present) 
...
dup_zero <- phy_c %>% 
  arrange(aphiaidaccepted, datecollected, xUTM, yUTM, present, season) %>%
  select(-datasetID) %>%
  duplicated %>% which
...
phy_c <- phy_c %>%
  distinct(aphiaidaccepted, scientificnameaccepted, datecollected, xUTM, yUTM, year, season, present, .keep_all = TRUE) 
