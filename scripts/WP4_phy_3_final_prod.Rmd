...
phy_sp <- phy %>%
  distinct(aphiaidaccepted, scientificnameaccepted, datecollected, eventid, xUTM, yUTM, year,
         season, present, .keep_all = TRUE) # Here we remove the duplicates that originated from two datasets (phy_southern_ns_71_73 and 
